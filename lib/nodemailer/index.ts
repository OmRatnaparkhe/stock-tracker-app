...
export const sendWelcomeEmail = async({name,email,intro}:WelcomeEmailData)=>{
    ...
    const mailOptions={
        from:`Signalist <signalist@ratnaparakheom.com`,
        to:email,
...
export const sendNewsSummaryEmail = async(
    {date,email,newsContent}:{email:string,date:string, newsContent:string}
):Promise<void>=>{
    ...
    const mailOptions = {
        from:`*Signalist News* <signalist@ratnaparkheom.com>`,
        to:email,
